...
exports.handler = function(event, context) {
    ...
    let intentParams = [
        
        {
            ...
            "fulfillmentLambda": {
                "region": "us-east-1",
                "accountId": "232429559327",
                "lambdaArn": "arn:aws:lambda:us-east-1:232429559327:function:kendraBot",
                "lambdaName": "kendraBot",
            },
            "fulfillmentActivity": {
                "type": "CodeHook",
                "codeHook": {
                    "messageVersion": "1.0",
                    "uri": "arn:aws:lambda:us-east-1:232429559327:function:kendraBot"
                }
            }, 
